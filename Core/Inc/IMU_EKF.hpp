...
#ifndef INC_IMU_EKF_HPP_
#define INC_IMU_EKF_HPP_
/*
 * EKF.h
 *
...
public:
	...
	IMU_EKF();
	void updateEKF(IMU_data data_imu, float dt){
//          quaternion state ;
          float recipNorm;
...
//         H.print();
         ...
         Matrix temp3 = mul_mat(H,P);
         Matrix temp4 = mul_mat(temp3,transpose(H));
